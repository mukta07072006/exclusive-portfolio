...
export const Terminal = ({
  ...
  const content = (
    <div
      ref={containerRef}
      className={cn(
        "border-violet-500/30 z-0 h-full max-h-100 lg:w-full w-[78vw] max-w-full px-8 rounded-xl border",
        "bg-gradient-to-br from-violet-800 to-black",
        className
      )}
    >
      <div className="border-violet-400/30 flex flex-col gap-y-2 border-b p-4">
